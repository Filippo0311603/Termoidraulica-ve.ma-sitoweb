            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="lg:w-1/2 reveal">
                        ...
                        <p className="text-gray-600 text-lg leading-relaxed mb-8">Siamo specializzati esclusivamente nella <strong>vendita</strong> di forniture civili e industriali. Che tu sia un professionista o un installatore, nella nostra sede troverai competenza, cortesia e un magazzino sempre fornito dei migliori prodotti e dei ricambi più introvabili.</p>
